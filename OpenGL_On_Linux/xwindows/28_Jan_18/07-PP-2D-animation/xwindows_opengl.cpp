...
GLfloat angle_triangle;
GLfloat angle_square;
...
void display(){
	...
	modelViewMatrix *= vmath::rotate(angle_triangle, 0.0f, 1.0f, 0.0f);
	...
	modelViewMatrix = modelViewMatrix * translate(2.0f, 0.0f, -6.0f);
	modelViewMatrix *= vmath::rotate(angle_triangle, 1.0f, 0.0f, 0.0f);
...
void update(){
	if(angle_triangle > 360.0){
		angle_triangle = angle_square = 0.0f;
	}else{
