...
std::ofstream g_gpu_extensions_file;
...
void initialize() {
	...
	//Know your GPU extensions
	GLint numberOfExtensions = 0;
	g_gpu_extensions_file.open("GPU_extensions.txt", std::ios::out);
	
	if (!g_gpu_extensions_file.is_open()) {
	...
	for (int i = 0;i < numberOfExtensions;i++) {
		g_gpu_extensions_file << glGetStringi(GL_EXTENSIONS, i)<<std::endl;
	}
