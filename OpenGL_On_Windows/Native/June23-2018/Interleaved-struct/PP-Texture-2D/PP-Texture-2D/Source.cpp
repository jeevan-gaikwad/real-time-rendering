...
//				g_log_file << "Shader program linking log:" << szInfoLog << std::endl;
	...
	cout<<"offset of position:"<<(&meshData-&meshData)<<endl;
	cout<<"offset of normals:"<<((&meshData.normals[0])-&meshData.position[0])<<endl;
	cout<<"offset of color:"<<((&meshData.color[0])-&meshData.position[0])<<endl;
	cout<<"offset of texel:"<<((&meshData.texel[0])-&meshData.position[0])<<endl;
	*/
