...
var kaUniform, kdUniform, ksUniform, materialShininessUniform, isPerVertexLightingUniform, isPerFragmentLightingUniform;
...
function init(){
    ...
    isPerVertexLightingUniform = gl.getUniformLocation(shaderProgramObject, "u_is_per_vertex_lighting"); //V/v key pressed or not
	isPerFragmentLightingUniform = gl.getUniformLocation(shaderProgramObject, "u_is_per_fragment_lighting"); //F/f key pressed or not
	sphere = new Mesh();
...
function draw()
{
	...
	if (isPerVertex) {
		gl.uniform1i(isPerVertexLightingUniform, 1);
		gl.uniform1i(isPerFragmentLightingUniform, 0);
	}
	else
	{
		gl.uniform1i(isPerFragmentLightingUniform, 1);
		gl.uniform1i(isPerVertexLightingUniform, 0);
	}
