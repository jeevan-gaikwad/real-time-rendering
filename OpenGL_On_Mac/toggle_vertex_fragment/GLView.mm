...
@private
	...
	bool gbLight;
	GLfloat gAngle;
	bool gbIsPerVertex; //Turn per vertex lighting by default on
	bool gbIsPerFragment;
...
-(id)initWithFrame:(NSRect)frame;
{
	...
	gbLight = false;
	gbAnimate = false;
	gbIsPerVertex = true; //Turn per vertex lighting by default on
...
-(void)prepareOpenGL
{
	...
	gIsPerFragmentLightingUniform = glGetUniformLocation(gShaderProgramObject, "u_is_per_fragment_lighting"); //F/f key pressed or
