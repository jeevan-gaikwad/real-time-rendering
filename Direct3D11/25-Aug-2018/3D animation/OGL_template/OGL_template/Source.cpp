...
HRESULT initialize()
{
	...
	bufferDescColors.ByteWidth = sizeof(float) * ARRAYSIZE(pyramidColors);
	...
	memcpy(mappedSubresourceColorsTriangle.pData, pyramidColors, sizeof(pyramidColors));
