...
- (id) initWithFrame:(CGRect)frame
{
    ...
    if(self)
    {
        ...
        glBufferData(GL_ARRAY_BUFFER, sizeof(smileyFaceVertices), smileyFaceVertices, GL_STATIC_DRAW); //we will provide data at runtime DYNAMIC_DRAW
        ...
        glBufferData(GL_ARRAY_BUFFER, 32, NULL, GL_DYNAMIC_DRAW); //we'll provide texture coordinates
