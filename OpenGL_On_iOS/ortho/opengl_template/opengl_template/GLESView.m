...
-(void)drawView:(id)sender
{
    ...
    modelViewProjectionMatrix = orthographicProjectionMatrix * modelViewMatrix; //ORDER IS IMP
...
-(void)layoutSubviews
{
    ...
    if (width <= height)
        ...
        orthographicProjectionMatrix = vmath::ortho(
                                                    ...
                                                    -100.0f, 100.0f);    if(glCheckFramebufferStatus(GL_FRAMEBUFFER) != GL_FRAMEBUFFER_COMPLETE)
    {
